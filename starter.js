...
// creating a higher order function that will take the above functions as callback. Its gonna check if the arguments recieved are numbers and then invoke the callback function
...
const applyStoreDiscount= (arr,callback,discount) => {
    arr.forEach(product => {
        callback(product,discount)
    })
}

// applyStoreDiscount(dogProducts,applyFlatRateDiscount,2)
// console.log(dogProducts)
// applyStoreDiscount(catProducts,applyPercentDiscount,.25)
// console.log(catProducts)

// create a function that applies discount by catagory
...
// create a function that lets up apply discount based on inventory
...
const makePumperSandwich= makeSandwich("Pumpernickel")
const makeRyeSandwich= makeSandwich("Rye")

 console.log(makePumperSandwich(['cream cheese',`pepper`,`capicola`,`seasoning`]))
 console.log(makeRyeSandwich(['cream cheese',`pepper`,`capicola`]))
